...
se for fornecido 1, o retorno será -1. Se o parâmetro de entrada não for de nenhum dos
...
function inverteValor(valor) {
  ...
  if (tipo === 'boolean') {
    ...
    resultado = `booleano ou número esperados, mas o parâmetro é do tipo ${tipo}`;
  }
  return resultado;
}
...
console.log(inverteValor(10));
console.log(inverteValor(-5));
console.log(inverteValor('a'));
